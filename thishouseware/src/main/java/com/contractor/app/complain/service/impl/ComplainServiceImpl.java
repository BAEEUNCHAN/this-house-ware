...
public class ComplainServiceImpl implements ComplainService {
	 ...
	 * // 문의 등록
	 * 
	 * @Override public int insertComplain(ComplainsVO complainVO) { int result =
	 * complainMapper.insertComplainInfo(complainVO); return result == 1 ?
	 * complainVO.getComplainNo() : -1; }
	 * 
	 * // 문의 삭제
	 * 
